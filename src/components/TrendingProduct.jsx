   ...
   return (
      <>
         ...
         <div className="relative w-full">
            ...
            <button
               onClick={scrollLeft}
               className="absolute left-2 top-1/2 -translate-y-1/2 bg-[#f7ce39] p-2 rounded-full translate-z-48"
            >
            ...
            <button
               onClick={scrollRight}
               className="absolute right-2 top-1/2 -translate-y-1/2 bg-[#f7ce39] p-2 rounded-full z-48"
            >
