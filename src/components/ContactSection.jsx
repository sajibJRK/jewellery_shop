...
export default function ContactSection() {
   return (
      <section className="w-full rounded-md bg-[#0F1B2B] text-white py-16 px-6 md:px-16">
         ...
         <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
               ...
               <p className="text-amber-100">
                  Have a question? Looking for something special? Our team is
                  ready to assist you.
               </p>
            ...
            <form className="bg-[#132030] border border-amber-300/40 rounded-lg p-8 space-y-5 shadow-[0_0_20px_rgba(247,206,57,0.2)]">
               ...
               <div>
                  <label className="block mb-2 text-amber-200">
                     Your Email
                  </label>
                  <input
                     type="email"
